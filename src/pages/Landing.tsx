...
const Landing = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 to-white">
      {/* Hero Section */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          <div className="flex justify-center items-center gap-3 text-blue-600 mb-4">
          <img src="https://i.imgur.com/Do9TlC0.png" width={80} alt="Rev-Vote Logo" />
          </div>
          <div>
            <h1 className="text-4xl tracking-tight font-TrainOne text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block">Rev-Vote</span>
            </h1>
          </div>
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-cyan-200 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
